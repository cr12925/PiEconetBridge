...
#define EMF_PBUF_LASTSEEN_IRQ_HARD_WRITER	0x08
#define EMF_PBUF_LASTSEEN_IRQ_HARD_WRITE_WAIT	0x09
#define EMF_PBUF_LASTSEEN_IRQ_HARD_WRITER_LASTBYTE	0x0A
#define EMF_PBUF_LASTSEEN_IRQ_HARD_WRITER_LASTBYTE_NEXTIRQ	0x0B
#define EMF_PBUF_LASTSEEN_IRQ_HARD_WRITER_LASTBYTE_NEXTIRQ_NOFC	0x0C
#define EMF_PBUF_LASTSEEN_IRQ_SOFT_WRITER_LASTBYTE	0x0D
