...
FSOP(0a)
{
	...
	usleep (50000); /* For RISC OS (and some beebs?) - Sometimes they don't have they're receiver port open fast enough and everything goes out of sync */ /* Not required with module-fast? */
